...
typedef SMARTP<guidocomment> 	Sguidocomment;
...
typedef SMARTP<ARTag<kTAccidental> > SARAccidental;
typedef SMARTP<ARTag<kTAccol> > 	SARAccol;
typedef SMARTP<ARTag<kTAlter> > 	SARAlter;
typedef SMARTP<ARTag<kTArpeggio> > 	SARArpeggio;
...
typedef SMARTP<ARTag<kTBeamsFull> > SARBeamsFull;
...
typedef SMARTP<ARTag<kTCluster> > 	SARCluster;
...
typedef SMARTP<ARTag<kTDecrescBegin> > 	SARDecrescBegin;
typedef SMARTP<ARTag<kTDecrescEnd> > 	SARDecrescEnd;
...
typedef SMARTP<ARTag<kTFBeam> > 	SARFBeam;
typedef SMARTP<ARTag<kTFBeamBegin> > SARFBeamBegin;
typedef SMARTP<ARTag<kTFBeamEnd> > 	SARFBeamEnd;
...
typedef SMARTP<ARTag<kTFooter> > 	SARFooter;
typedef SMARTP<ARTag<kTGlissando> > SARGlissando;
typedef SMARTP<ARTag<kTGlissandoBegin> > SARGlissandoBegin;
typedef SMARTP<ARTag<kTGlissandoEnd> > 	SARGlissandoEnd;
typedef SMARTP<ARTag<kTGrace> > 	SARGrace;
typedef SMARTP<ARTag<kTHarmonic> > 	SARHarmonic;
...
typedef SMARTP<ARTag<kTMrest> > 	SARMrest;
...
typedef SMARTP<ARTag<kTPedalOff> >	SARPedalOn;
typedef SMARTP<ARTag<kTPedalOn> > 	SARPedalOff;
typedef SMARTP<ARTag<kTPizz> >  	SARPizz;
...
typedef SMARTP<ARTag<kTTremBegin> > SARTremBegin;
typedef SMARTP<ARTag<kTTremEnd> > 	SARTremEnd;
typedef SMARTP<ARTag<kTTrill> > 	SARTrill;
typedef SMARTP<ARTag<kTTrillBegin> > SARTrillBegin;
typedef SMARTP<ARTag<kTTrillEnd> > 	SARTrillEnd;
typedef SMARTP<ARTag<kTTuplet> > 	SARTuplet;
typedef SMARTP<ARTag<kTTupletBegin> > 	SARTupletBegin;
typedef SMARTP<ARTag<kTTupletEnd> > 	SARTupletEnd;
