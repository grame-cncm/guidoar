...
#define yyparse glangparse
#define yylex   glanglex
#define yyerror glangerror
#define yylval  glanglval
#define yychar  glangchar
#define yydebug glangdebug
#define yynerrs glangnerrs
