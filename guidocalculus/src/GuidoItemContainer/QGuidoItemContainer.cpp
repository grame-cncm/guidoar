...
//		mGuidoItem->scale( boundedSx , boundedSy );
		mGuidoItem->setTransform(QTransform::fromScale(boundedSx, boundedSy), true);
		guidoGeometryChanged();
...
//	mGuidoItem->scale( otherContainer->mGuidoItem->transform().m11() , otherContainer->mGuidoItem->transform().m22() );
	mGuidoItem->setTransform(QTransform::fromScale(otherContainer->mGuidoItem->transform().m11(), otherContainer->mGuidoItem->transform().m22()), true);
