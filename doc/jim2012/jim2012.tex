...
Une coupure brute de la partition après 2 notes donne le code \code{[e\ c]} où l'information de clef a disparu, pouvant conduire à un rendu non souhaité (figure \ref{fig:tail}).
\begin{figure}[h]
...
La résolution du problème requiert le support du langage GMN : nous introduisons un nouveau paramètre pour les tags d'étendue temporelle explicite, conservant l'histoire du tag et indiquant un antécédent de forme \oend\ et/ou \obeg\ .
Ce paramètre est e la forme : 
...
Nous introduisons ensuite une nouvelle règle pour la composition de partitions, qui nécessite de définir des tags \emph{adjacents} comme des tags placés sur la même voix et qui ne sont séparés par aucune note ou accord.
\begin{itemize}
...
\end{itemize}
Ainsi, si une opération rencontre une forme de type :
