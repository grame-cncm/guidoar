...
\newcommand{\bevalApply}[3][\evalexpr]	{\ensuremath{\apply{#1{#2}}{#1{#3}}}}
...
\newcommand{\bapplySeq}[3]	{\ensuremath{\seqOp{\apply{#1}{\headOp{#3}{\dur(#1)}}}{\apply[\bounds(l:=l-\length\left(\apply{#1}{\headOp{#3}{\dur(#1)}}\right)]{#1}{\tailOp{#3}{\dur(#1)}}}}}
\newcommand{\bapplyMix}[3]	{\ensuremath{\mixOp{\apply{#1}{\topOp{#3}{\voices(#1)}}}{\apply[\bounds(v:=v-\voices\left(\apply{#1}{\topOp{#3}{\voices(#1)}}\right)]{#1}{\bottomOp{#3}{\voices(#1)}}}}}
...
%and $\head( \top (\evalss{\lambdaexpr{e}{f}}, \bounds(v)), \bounds(l))$ &  \ra & $\head( \top (\closure{\envsym}{e}{f}{\bounds'}, \bounds(v)), \bounds(l))$ \\
